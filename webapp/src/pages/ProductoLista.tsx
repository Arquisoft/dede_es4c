			...
			<Card sx={{ maxWidth: 345 }}>
				...
				<CardContent>
					<Typography gutterBottom variant="h5" component="div">
						{props.product.nombre.charAt(0).toUpperCase() +
							props.product.nombre.slice(1)}
					</Typography>
					<Typography>
						{esPicante(props.product) && (
							<Tooltip title="Picante">
								<Avatar
									alt="Este pincho pica"
									src={picante}
						...
						{esVegetariano(props.product) && (
							<Tooltip title="Vegetariano">
								<Avatar
									alt="Este pincho es válido para vegetarianos"
									src={vegetariano}
									sx={{ width: 25, height: 25 }}
								/>
							</Tooltip>
				...
				<CardActions>
					{!isInCart(props.product) && (
						<Button
							variant="contained"
							sx={{ color: "#fff", m: 1, backgroundColor: "#596886" }}
